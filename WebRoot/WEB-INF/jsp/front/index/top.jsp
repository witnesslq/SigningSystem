			...
			<td width="300" align="right" valign="top">
				<table width="350" border="0" cellpadding="0" cellspacing="0">
					...
					<tr>
					    <td align="center"></td>
                        <td align="left"></td>
                        <td align="left"><a><b><font color="red">欢迎您，${sessionScope.school.s_Name}</font></b></a></td>
...
<%-- 						<td align="left"><a href="${basePath }school/school_logout.action" target="_top">注销</a></td>
 --%>						<td width="17" align="center"><a href="${basePath }school/school_logout.action" target="_top"><img src="${basePath}images/nsfw/exit.png"width="14" height="14"/></a></td>
	...
	<div class="banner">
		<div class="menu">
			<ul class="clearfix">
				<li><a href="${basePath}common/welcome.jsp" target="mainFrame">统计表</a></li>
                <li><a href="${basePath}regulation.jsp" target="mainFrame">填表规则</a></li>
			</ul>
		</div>
	</div>
	<!-- }导航 -->
