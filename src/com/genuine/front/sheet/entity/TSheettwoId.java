...
/**
 * TSheettwoId entity. @author MyEclipse Persistence Tools
 */

public class TSheettwoId implements java.io.Serializable {
	...
	/** full constructor */
	public TSheettwoId(String SId, Integer rowId) {
		this.SId = SId;
		this.rowId = rowId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TSheettwoId))
			return false;
		TSheettwoId castOther = (TSheettwoId) other;
