...
/**
 * TSheetoneId entity. @author MyEclipse Persistence Tools
 */

public class TSheetoneId implements java.io.Serializable {
	...
	/** full constructor */
	public TSheetoneId(String SId, Integer rowId) {
		this.SId = SId;
		this.rowId = rowId;
	}
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TSheetoneId))
			return false;
		TSheetoneId castOther = (TSheetoneId) other;
